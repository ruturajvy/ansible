...
class TestExosVlanModule(TestExosModule):
    ...
    def make_vlan_result(self, changed, *args):
        ...
        for each in args:
            ...
            if method is not 'DELETE':
                ...
                [{"config":
                 {"vlan-id": None ,"status": "ACTIVE","tpid": "oc-vlan-types:TPID_0x8100","name": None}
                 }]}
    ...
    def test_exos_vlan_aggregate(self, *args, **kwargs):
        ...
        self.assertCountEqual(
            result['requests'],
            self.make_vlan_result(True, (500, 'ansible_500', 'POST'), (400, 'ansible_400', 'POST'))['requests']
        )
    ...
    def test_exos_vlan_purge(self, *args, **kwargs):
        ...
        self.assertCountEqual(
            result['requests'],
            self.make_vlan_result(True, (500, 'ansible_500', 'POST'), (400, 'ansible_400', 'POST'), 
            (100, None, 'DELETE'), (300, None, 'DELETE'), (200, None, 'DELETE'))['requests']
        )
    def test_exos_vlan_interfaces(self, *args, **kwargs): 
        ...
        result['requests'],
            ...
            "method": "PATCH",
            "path": "/rest/restconf/data/openconfig-interfaces:interfaces/interface=1/openconfig--if-ethernet:ethernet/openconfig-vlan:switched-vlan/"
            },
            {
            "data": {
                "openconfig-vlan:switched-vlan": {
            ...
            "method": "PATCH",
            "path": "/rest/restconf/data/openconfig-interfaces:interfaces/interface=2/openconfig--if-ethernet:ethernet/openconfig-vlan:switched-vlan/"
            },
            {
            "data": {
                "openconfig-vlan:switched-vlan": {
            ...
            "method": "PATCH",
            "path": "/rest/restconf/data/openconfig-interfaces:interfaces/interface=3/openconfig--if-ethernet:ethernet/openconfig-vlan:switched-vlan/"
            }] )
